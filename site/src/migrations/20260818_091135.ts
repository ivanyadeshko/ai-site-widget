...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  ...
  CREATE TABLE "header" (
  	"id" serial PRIMARY KEY NOT NULL,
  	"brand" varchar DEFAULT 'Vell' NOT NULL,
  	"login_label" varchar DEFAULT 'Войти',
  	"register_label" varchar DEFAULT 'Начать бесплатно',
  ...
  CREATE TABLE "pricing_plans" (
  	...
  	"cta_label" varchar DEFAULT 'Начать бесплатно' NOT NULL
  );
  
  CREATE TABLE "pricing" (
  	"id" serial PRIMARY KEY NOT NULL,
  	"title" varchar DEFAULT 'Тарифы' NOT NULL,
  	"subtitle" varchar,
  	"note" varchar,
  	"updated_at" timestamp(3) with time zone,
  	"created_at" timestamp(3) with time zone
  ...
  CREATE TABLE "footer" (
  	"id" serial PRIMARY KEY NOT NULL,
  	"tagline" varchar,
  	"copyright" varchar DEFAULT '© Vell',
  	"updated_at" timestamp(3) with time zone,
  	"created_at" timestamp(3) with time zone
  );
